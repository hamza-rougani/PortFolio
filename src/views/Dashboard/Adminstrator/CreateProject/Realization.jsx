...
function Realization() {
  const {realization,setrealization} = useStateContext()
  ...
  const handlecreate = ()=>{
    ...
    if(info.title!="" && info.desc!="" && typeof(info.image) == typeof([])){
      ...
      setOverviewData((prevState) => ({
        ...
        image: [...prevState.images,info.image],
      }));
    ...
    <div className='Overview'>
      <div className='addline'>
        ...
        <div className='addform'>
          ...
          <button className="btn add" onClick={()=>setrealization(OverviewData)}>Confirme</button>
          </div>
        </div>
