...
function Solution(e) {
  ...
  const [OverviewList,setOverviewList] = useState(solution ? solution.title.length>0 ? solution:{title:"",desc:""}:{title:"",desc:""})
      ...
      <div className='addline'>
        ...
        <div className='addform'>
         ...
         ""
          ...
          <button className="btn add" onClick={()=>setsolution(e.p?infoEdit:OverviewList)}>Confirme</button>
